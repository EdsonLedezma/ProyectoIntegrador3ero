  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="custom-menu-item"><a href="servicios.php">Services</a></li>
        <li class="custom-menu-item"><a href="tipos.php">Quote</a></li>
        <li class="custom-menu-item"><a href="tipos-cotizacion3.php">Switch to Spanish</a></li>
          ...
          <div class="card">
            ...
            <div class="card-body d-flex flex-column justify-content-between">
              <div>
                ...
                <p class="card-text card-title">PickUp price: ' . $row['preciopickup'] . '</p>
              </div>
              <div class="align-self-end">
                <label class="custom-checkbox">
                  <input type="checkbox" class="checkbox-input" name="servicio" value="' . $row['preciopickup'] . '">
                  <span class="checkmark"></span>
                  <span class="btn btn-primary btn-quote">Select service</span>
                </label>
              </div>
            </div>
          </div>
...
<div class="container text-center">
  <div class="row">
    <div class="col-lg-12">
      <h4>Total: <span id="precioTotal">0</span></h4>
    </div>
  </div>
</div>
