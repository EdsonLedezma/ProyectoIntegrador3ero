  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="custom-menu-item"><a href="tipos-cotizacion2.php">Switch to Spanish</a></li>
          ...
          <div class="card">
            ...
            <div class="card-body d-flex flex-column justify-content-between">
              <div>
                ...
                <p class="card-text card-title">SUV price: ' . $row['preciosuv'] . '</p>
              </div>
              <div class="align-self-end">
                <label class="custom-checkbox">
                  <input type="checkbox" class="checkbox-input" name="servicio" value="' . $row['preciosuv'] . '">
